...
<head>
    ...
    <title>Registar - Gestor de Stock</title>
        ...
        <div class="auth-left">
            <div class="illustration">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- User circle -->
                    <circle cx="100" cy="70" r="30" fill="none" stroke="white" stroke-width="3"/>
                    <!-- User body -->
                    <path d="M 70 105 Q 70 90 100 90 Q 130 90 130 105 L 130 140 Q 130 150 120 150 L 80 150 Q 70 150 70 140 Z" fill="none" stroke="white" stroke-width="3"/>
                    <!-- Checkmark -->
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('auth.register.post') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" required value="{{ old('name') }}" placeholder="João Silva">
                    </div>
                ...
                <div class="form-footer">
                    <p>Já tens conta? <a href="{{ route('auth.login') }}">Fazer login</a></p>
                </div>
            </div>
        </div>
    </div>
